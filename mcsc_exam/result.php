		...
		<div class="row" id="iform">
			...
			<div class="col-xs-10 col-sm-8 col-md-4 red_boxx">
				<div class="card mt-5 d-print-none">
					<div class="card-header">
						<h4 class="card-title">Report Card Download : Organized by Mahamaya CSC </h4>
					</div>
					<div class="card-body">
		  ...
		  <div class="card mt-2" id="mbodyx" style="display:none;">
			<div class="card-header d-flex">
				<div class="h5 mt-1">Report Card Download : Organized by Mahamaya CSC</div>
				<div class="ml-auto">
			...
			<div class="row m-3 mx-1 p-1 border">
			  <div class="col"><b>Correct Answer: </b><span id="cans"></span></div>
			  <div class="col"><b>Wrong Answer: </b><span id="wans"></span></div>
			</div>
		  </div>
		...
		$.ajax({
			...
			success: function(msg){
				if(msg=="FAIL"){
					...
					data=JSON.parse(msg);
					document.title="Report Card of " + data["student"]["candidate-name"] + " - " + data["student"]["roll-no"] + " :: SoRi Soft";
