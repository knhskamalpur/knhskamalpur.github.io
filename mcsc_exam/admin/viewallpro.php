...
<div class="col border border-dark">Mobile No</div>
		...
		echo '<div class="row d-flex justify-content-around">
			<div class="col border border-dark">'.$metadata['candidate-name'].'</div>
			<div class="col border border-dark">'.$metadata['c-o'].'</div>
			<div class="col border border-dark">'.$metadata['dob'].'</div>
			<div class="col border border-dark">'.$metadata['registration-no'].'</div>
<div class="col border border-dark">'.@$metadata['mobile-no'].'</div>

			<div class="col border border-dark">'.$metadata['roll-no'].'</div>
			<div class="col border border-dark">'.$metadata['exam-date'].'  '.$metadata['batch'].'</div>
		</div>';
		//var_dump($metadata);
	}
}
